    ...
    <div className="section-padding">
      ...
      <div className="max-w-7xl mx-auto pb-12">
        <SectionHeader 
          ...
          subtitle="수주 및 수행 중인 주요 정부 지원 국가 연구 개발 과제 및 글로벌 국책 공동 연구 현황."
          centered
        />

        {/* Dynamic Project Grid/Rows */}
        <div className="max-w-5xl mx-auto mt-12">
          <div className="py-16 text-center border border-dashed border-slate-200 rounded-3xl bg-slate-50/30">
            <p className="text-slate-400 text-sm font-light">
              등록된 과제 수주 및 수행 현황이 없습니다. 추후 업데이트 예정입니다.
            </p>
          </div>
        </div>
      </div>
